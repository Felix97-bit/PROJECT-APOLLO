  ...
  const CON_TEMPLATES = [
    ...
    { // Orion — the hunter, with belt + a detailed sketch of the warrior
      ...
      figure: [
        ...
        { t: "faint", d: "M 0.3 0.216 C 0.315 0.232 0.324 0.252 0.328 0.272 M 0.316 0.302 C 0.33 0.312 0.342 0.324 0.347 0.338" },
        { t: "faint", d: "M 0.616 0.216 C 0.602 0.236 0.593 0.258 0.59 0.28 M 0.6 0.312 C 0.586 0.33 0.572 0.346 0.56 0.362" },
        ...
        { t: "faint", d: "M 0.435 0.345 L 0.435 0.452 M 0.514 0.345 L 0.511 0.44" },
